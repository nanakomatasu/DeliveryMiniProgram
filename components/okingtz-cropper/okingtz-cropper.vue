<template>
	<view class="container">
		<view class="page-body uni-content-info">
			...
			<view class="flex">
<!-- 				<view :style="'background-color: '+selectButtonBackgroundColor+';color: '+selectButtonColor+';'" @click.stop="getImage">{{ selectButtonText }}</view>
				<view class="m-l-25"  :style="'background-color: '+saveButtonBackgroundColor+';color: '+saveButtonColor+';'" @click.stop="getImageInfo">{{ saveButtonText }}</view> -->
			</view>
			...
			writeImage(path){
				...
				ctx.draw(true, () => {
					...
					uni.canvasToTempFilePath({
						...
						success: function (res) {
							uni.hideLoading()
							_this.$emit('uploadSuccess',res.tempFilePath,false)
						},
						fail:function(err){
